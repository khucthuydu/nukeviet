                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input onchange="nv_change_catid_edit(this, {rowcontent.id})" id="catright_{CATS.catid}" style="{CATS.catiddisplay}" type="radio" name="catid" title="{LANG.content_checkcat}" value="{CATS.catid}" {CATS.catidchecked}/></td>
                            </tr>
                            <!-- END: catid -->
                        </tbody>
                    </table>
