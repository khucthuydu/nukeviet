...
var urload = nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + nv_module_name_shop + '&' + nv_fc_variable + '=loadcart2';
	...
	$(".remove-cart-block").click(function() {
		...
		$.ajax({
			...
			success : function(data) {
				if (data != '') {
					$("#" + data).html('');
					$("#cart2_" + nv_module_name_shop).load(urload);
					$("#total").load(urload + '&t=2');
				}
